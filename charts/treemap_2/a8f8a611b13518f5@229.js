...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["flare.json", {url: new URL("https://raw.githubusercontent.com/AndoniAranguren/HerramientasDeVisualizacionSteam/main/data/hierarchy_publisher_developer_game_count.json", import.meta.url), mimeType: "application/json", toString}]
  ]);
