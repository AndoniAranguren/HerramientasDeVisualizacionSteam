...
Inputs.textarea({
  value: (await FileAttachment("languages_all.txt").text()).trim(),
  rows: 20,
  width
})
)}
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["languages_all.txt", {url: new URL("././../../data/languages_all.txt", import.meta.url), mimeType: "text/plain", toString}]
  ]);
